...
import {addOrder, getOrders, getUserOrders} from "../../../actions/orders.action";
import Grid from "@material-ui/core/Grid";
import Divider from "@material-ui/core/Divider";
import Fab from "@material-ui/core/Fab";
import './AdminOrderDetail.scss'
import {LocalShipping} from "@material-ui/icons";
import {shipOrder} from "../../../actions/user.action";
    ...
    return (order.order?
            <Grid container className='orderDetail'>
                ...
                <Grid container item lg={11} md={11} sm={11} xs={11} className='product-summary'>
                    ...
                    <Grid item lg={12} md={12} sm={12} xs={12} className='btn-row'>
                        {
                            order.order.status==="shipped"?
                                ...
                                <Fab
                                    ...
                                    onClick={handleShip}
                                >
                                    Ship Items <LocalShipping style={{margin:10}}/>
                                </Fab>
                        }
